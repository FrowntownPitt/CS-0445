...
public class SortArrayInstrumented {
    ...
    private void endStatistics(){
        ...
        minComparisons = (comparisons < minComparisons) ? comparisons:minComparisons;
        maxComparisons = (comparisons > maxComparisons) ? comparisons:maxComparisons;
    }
    ...
    int getIndexOfSmallest(T[] a, int first, int last) {
        ...
        for (int index = first + 1; index <= last; index++) {
            //System.out.println("Incrementing comparisons: "+comparisons);
            comparisons++;

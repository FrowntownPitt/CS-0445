...
public class SortDriver
{
    ...
    public static void main(String args[])
    {
        ...
        //trials = getInt("Enter the number of trials: ");
        ...
        System.out.println("Minimum comparisons: " + sai.getMinComparisons());
        System.out.println("Maximum comparisons: " + sai.getMaxComparisons());
        System.out.println("Average Comparisons: " + sai.getTotalComparisons()/trials);

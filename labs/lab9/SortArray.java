...
public class SortArray
{
    ...
    * @return The index of the pivot */
    ...
    /** bitonicMerge sort on a portion of an array.  Creates a temporary array
     *  then calls the recursive function.
     * @param a An array of Comparable objects.
     * @param first An integer >= 0 that is the index of the first
     * array entry to consider.
    ...
    /** Recursively bitonicMerge sort a portion of an array.
     * @param a An array of Comparable objects.
     * @param tempArray An array used by the bitonicMerge step.
     * @param first An integer >= 0 that is the index of the first
     * array entry to consider.
     * @param last An integer >= 0 that is the index of the last
     * array entry to consider.
    ...
    /** bitonicMerge the entries in two contiguous sorted sublists 
     * @param a An array of Comparable objects.
     * @param tempArray A temporary array used in the bitonicMerge.
     * @param first An integer >= 0 and < mid.
     * @param mid An integer  <= last.
     * @param last An integer  < a.length.
     */

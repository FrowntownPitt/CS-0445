...
public class RationalTest
{
    ...
    public static void testEquals()
    {
        ...
        System.out.println("Trying with 1/1 and 1/1");
        ...
        if(r1.equals(r2)) {
            ...
            System.out.println("**** Fails - not returning equal");
        }

        System.out.println("Trying with 0/1 and 0/5");
        r1 = new Rational(0,1);
        r2 = new Rational(0,5);
        if(r1.equals(r2)) {
            System.out.println("     Passes");
        ...
        System.out.println("Trying with 1/3 and 5/7");
        r1 = new Rational(1,3);
        r2 = new Rational(5,7);
        if(!r1.equals(r2)) {
            System.out.println("     Passes");
            ...
            System.out.println("**** Fails - not returning not equal");
        }
    System.out.println("ToString tests finished");
    }
    ...
    public static void testString()
    {
        ...
        System.out.println("Trying with 1/2");
        Rational r0 = new Rational(1,2);
        if(r0.toString().equals("1/2")) {
            System.out.println("     Passes");
        }
        else{
            System.out.println("**** Fails - string not equal to \"1/2\"");
        }

        System.out.println("Trying with 0/1");
        r0 = new Rational(0,1);
        if(r0.toString().equals("0/1")) {
            System.out.println("     Passes");
        }
        else{
            System.out.println("**** Fails - string not equal to \"0/1\"");
        }

        System.out.println("Trying with -2/5");
        r0 = new Rational(-2,5);
        if(r0.toString().equals("-2/5")) {
            System.out.println("     Passes");
        }
        else{
            System.out.println("**** Fails - string not equal to \"-2/5\"");
        }
    System.out.println("ToString tests finished");
    }
